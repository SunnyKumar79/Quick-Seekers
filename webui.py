            ...
            with gr.Row(visible=modules.config.default_image_prompt_checkbox) as image_input_panel:
                with gr.Tabs(selected=modules.config.default_selected_image_input_tab_id):
                    ...
                    with gr.Tab(label='Image Prompt', id='ip_tab') as ip_tab:
                        ...
                        gr.HTML('* \"Image Prompt\" is powered by Fooocus Image Mixture Engine (v1.0.1). <a href="#" target="_blank">\U0001F4D4 Documentation</a>')
                        ...
                        with gr.Row():
                            with gr.Column():
                                ...
                                example_inpaint_prompts = gr.Dataset(samples=modules.config.example_inpaint_prompts,
                                                                     ...
                                                                     visible=False)
                                gr.HTML('* Powered by Fooocus Inpaint Engine <a href="#" target="_blank">\U0001F4D4 Documentation</a>')
